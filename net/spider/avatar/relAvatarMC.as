...
package net.spider.avatar
{
    ...
    public class relAvatarMC extends MovieClip 
    {
        ...
        private const NEGA_MAX_RATIO:Number = -4.6566128752458E-10;
        ...
        private function onClickHandler(param1:MouseEvent):void
        {
            ...
            else
            {
                if (!param1.ctrlKey)
                {
                    ...
                    {
                        if (_loc2_ != this.world.myAvatar.target)
                        {
        ...
        public function modulateColor(param1:ColorTransform, param2:String):void
        {
            ...
            this.clampedTransform.alphaOffset = _loc3_.clamp(this.totalTransform.alphaOffset, -255, 0xFF);
            this.clampedTransform.redMultiplier = _loc3_.clamp(this.totalTransform.redMultiplier, -1, 1);
            this.clampedTransform.redOffset = _loc3_.clamp(this.totalTransform.redOffset, -255, 0xFF);
            this.clampedTransform.greenMultiplier = _loc3_.clamp(this.totalTransform.greenMultiplier, -1, 1);
            this.clampedTransform.greenOffset = _loc3_.clamp(this.totalTransform.greenOffset, -255, 0xFF);
            this.clampedTransform.blueMultiplier = _loc3_.clamp(this.totalTransform.blueMultiplier, -1, 1);
            this.clampedTransform.blueOffset = _loc3_.clamp(this.totalTransform.blueOffset, -255, 0xFF);
            ...
            if (((Point.distance(this.op, this.tp) > 0.5) && (this.mcChar.onMove)))
            {
                ...
                if (this.pAV.isMyAvatar)
                {
                    ...
                    while (_loc11_ < this.STAGE.arrEvent.length)
                    {
                        ...
                        {
                            if (this.shadow.hitTestObject(this.STAGE.arrEvent[_loc11_].shadow))
                            {
                                _loc12_ = true;
                            };
                        };
                        ...
                        {
                            if (this.STAGE.arrEvent[_loc11_]._entered)
                            {
        ...
        public function endAction():void
        {
            ...
            if (!this.checkQueue(null))
            {
                ...
                {
                    if (((_loc1_ == null) || ((!(_loc1_ == null)) && ((((_loc1_.currentLabel == "Die") || (_loc1_.currentLabel == "Feign")) || (_loc1_.currentLabel == "Dead")) || ((this.pAV.target.npcType == "player") && ((!("pvpTeam" in this.pAV.dataLeaf)) || (this.pAV.dataLeaf.pvpTeam == this.pAV.target.dataLeaf.pvpTeam)))))))
                    {
        ...
        private function drawHitBox():void
        {
            ...
            _loc5_.lineStyle(0, 0xFFFFFF, 0);
            _loc5_.beginFill(0xAA00FF, 0);
