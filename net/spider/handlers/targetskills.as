...
//net.spider.handlers.targetskills
        ...
        public function createIconMC(auraName:String, auraStacks:Number, isEnemy:Boolean):void
        {
            ...
            if (main.Game.ui.mcPortraitTarget)
            {
                if (!main.Game.ui.mcPortraitTarget.getChildByName("auraUI"))
                {
                    ...
                    auraUI.x = 16;
                    auraUI.y = 85;
                    main.Game.ui.mcPortraitTarget.getChildByName("auraUI").addEventListener(MouseEvent.MOUSE_DOWN, this.onHold, false, 0, true);
                    main.Game.ui.mcPortraitTarget.getChildByName("auraUI").addEventListener(MouseEvent.MOUSE_UP, this.onMouseRelease, false, 0, true);
                };
            };
